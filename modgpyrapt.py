...
The module is slightly modified from Daniel Gaspari's 'PyRapt':
Gaspari, Daniel. 2016. Mandarin Tone Trainer. Master's thesis,
Harvard Extension School.
https://dash.harvard.edu/bitstream/handle/1/33797313/GASPARI-DOCUMENT-2016.pdf?sequence=1
...
def _setup_rapt_params(kwargs):
    ...
    params = pyraptparams.Raptparams()
...
def _get_nccf_params(audio_input, pyraptparams, is_firstpass):
    """
